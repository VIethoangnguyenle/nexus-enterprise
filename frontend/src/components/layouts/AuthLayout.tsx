...
export function AuthLayout() {
  return (
    <div className="flex items-center justify-center min-h-screen p-6 bg-bg-primary
      bg-[radial-gradient(ellipse_at_50%_0%,rgba(51,112,255,0.08),transparent_60%)]">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute w-1 h-1 rounded-full bg-accent/20 top-[25%] left-[60%] animate-pulse [animation-delay:3s]" />
