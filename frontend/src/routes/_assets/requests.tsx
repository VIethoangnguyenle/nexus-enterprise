...
export const Route = createFileRoute('/_assets/requests')({ component: AssetRequests })
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <Heading as="h2">Asset Requests</Heading>
              ...
              <Card.Body className="flex items-center justify-between">
                ...
                {r.status === 'pending' && (
                  <div className="flex gap-2">
                    ...
                    >
                      {reject.isPending ? <Spinner size="sm" /> : '✕ Reject'}
                    </Button>
                  </div>
                )}
              </Card.Body>
