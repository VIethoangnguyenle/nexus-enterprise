...
## Purpose
Separate who a person is globally from who they are inside a tenant, so one human can hold memberships in many tenants without their identities leaking across the boundary.
