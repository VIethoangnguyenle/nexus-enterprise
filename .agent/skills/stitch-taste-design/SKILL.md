---
name: taste-design
description: "⚠️ DEPRECATED — Use agent-ux skill instead. This skill is no longer maintained."
---

> **⚠️ DEPRECATED**: This skill has been replaced by `.agent/skills/agent-ux/SKILL.md`.
> The agent-ux skill handles all UI/UX design work including Stitch integration.
> Do NOT use this skill for new work.

# Stitch Design Taste — Semantic Design System Skill (DEPRECATED)
