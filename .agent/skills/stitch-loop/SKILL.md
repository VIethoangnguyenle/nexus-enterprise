---
name: stitch-loop
description: "⚠️ DEPRECATED — Use autopilot skill instead. This skill is no longer maintained."
---

> **⚠️ DEPRECATED**: This skill has been replaced by `.agent/skills/autopilot/SKILL.md`.
> The autopilot orchestrator handles iterative design-to-code with Stitch integration.
> Do NOT use this skill for new work.

# Stitch Build Loop (DEPRECATED)
